...
import 'package:game/category1/game1/soundspell/soundspelllast.dart';

class SoundSpell20 extends StatefulWidget {
  ...
  @override
  _SoundSpell20State createState() => _SoundSpell20State();
}

class _SoundSpell20State extends State<SoundSpell20> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "The cat is sleeping on the couch",
      image: "assets/spell/catcouch.png",
    ),
  ];
          ...
          onPressed: () {
            if (widget.subscribedCategory == 'premium') {
              Navigator.pushReplacement(
                ...
                builder: (context) => SoundSpellLast(
