...
class SoundSpell19 extends StatefulWidget {
  ...
  @override
  _SoundSpell19State createState() => _SoundSpell19State();
}

class _SoundSpell19State extends State<SoundSpell19> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "The children are playing",
      image: "assets/spell/childrenplay.png",
    ),
  ];
