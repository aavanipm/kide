...
class SoundSpell18 extends StatefulWidget {
  ...
  @override
  _SoundSpell18State createState() => _SoundSpell18State();
}

class _SoundSpell18State extends State<SoundSpell18> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "The flowers bloom beautifully",
      image: "assets/spell/flowerbloom.png",
    ),
  ];
