...
class SoundSpell15 extends StatefulWidget {
  ...
  @override
  _SoundSpell15State createState() => _SoundSpell15State();
}

class _SoundSpell15State extends State<SoundSpell15> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "The book is red",
      image: "assets/spell/redbook.png",
    ),
  ];
