...
class SoundSpell17 extends StatefulWidget {
  ...
  @override
  _SoundSpell17State createState() => _SoundSpell17State();
}

class _SoundSpell17State extends State<SoundSpell17> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "The river flows calmly",
      image: "assets/spell/riverflo.png",
    ),
  ];
