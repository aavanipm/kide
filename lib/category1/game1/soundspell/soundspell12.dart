...
class SoundSpell12 extends StatefulWidget {
  ...
  @override
  _SoundSpell12State createState() => _SoundSpell12State();
}

class _SoundSpell12State extends State<SoundSpell12> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "The sun is shining",
      image: "assets/spell/sunshine.png",
    ),
  ];
