...
class SoundSpell3 extends StatefulWidget {
  ...
  @override
  _SoundSpell3State createState() => _SoundSpell3State();
}

class _SoundSpell3State extends State<SoundSpell3> {
  ...
  Widget _correct(Flashcard flashcard) {
    return Column(
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SoundSpell4(
              username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
            )));
          },
