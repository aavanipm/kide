...
class SoundSpell1 extends StatefulWidget {
  ...
  @override
  _SoundSpell1State createState() => _SoundSpell1State();
}

class _SoundSpell1State extends State<SoundSpell1> {
  ...
  Widget _correct(Flashcard flashcard) {
    return Column(
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SoundSpell2(
              username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
            )));
          },
