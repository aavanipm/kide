...
class SoundSpell6 extends StatefulWidget {
  ...
  @override
  _SoundSpell6State createState() => _SoundSpell6State();
}

class _SoundSpell6State extends State<SoundSpell6> {
