...
class SoundSpell16 extends StatefulWidget {
  ...
  @override
  _SoundSpell16State createState() => _SoundSpell16State();
}

class _SoundSpell16State extends State<SoundSpell16> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "The child laughs happily",
      image: "assets/spell/childlaugh.png",
    ),
  ];
