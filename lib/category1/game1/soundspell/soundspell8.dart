...
class SoundSpell8 extends StatefulWidget {
  ...
  @override
  _SoundSpell8State createState() => _SoundSpell8State();
}

class _SoundSpell8State extends State<SoundSpell8> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: 'Duck',
      image: "assets/Birds/duck.png",
    ),
  ];
