...
class SoundSpell13 extends StatefulWidget {
  ...
  @override
  _SoundSpell13State createState() => _SoundSpell13State();
}

class _SoundSpell13State extends State<SoundSpell13> {
  final FlutterTts flutterTts = FlutterTts();
  List<Flashcard> flashcards = [
    Flashcard(
      word: "Ice cream tastes sweet",
      image: "assets/spell/icecream.png",
    ),
  ];
