...
class SoundSpellLast extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  final String subscribedCategory;

  const SoundSpellLast({
    Key? key,
  ...
  @override
  State<SoundSpellLast> createState() => _SoundSpellLastState();
}

class _SoundSpellLastState extends State<SoundSpellLast> {
  @override
