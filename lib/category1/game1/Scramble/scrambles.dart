...
class Scrambles extends StatefulWidget {
  const Scrambles({super.key});

  @override
  _ScramblesState createState() => _ScramblesState();
}

class _ScramblesState extends State<Scrambles> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>const Scrambles()));
            },
            child: const Text('OK'),
          ),
        ],
