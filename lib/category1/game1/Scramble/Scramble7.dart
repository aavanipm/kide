...
class Scramble7 extends StatefulWidget {
  ...
  @override
  _Scramble7State createState() => _Scramble7State();
}

class _Scramble7State extends State<Scramble7> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Scramble Vegetables'),
  ...
  bool _isValidWord(String word) {
    List<String> validWords = [
      ...
      'CAULIFLOWER', 'ONION', 'GARLIC', 'BELL PEPPER', 'ZUCCHINI', 'EGGPLANT',
      'CABBAGE', 'RADISH', 'CELERY', 'ASPARAGUS',
      'GREEN BEAN', 'PEA', 'SWEET POTATO',
      'MUSHROOM', 'BRUSSELS SPROUTS', 'KALE', 'TURNIP', 'ARTICHOKE', 'BEET', 'PUMPKIN',
      'SQUASH', 'YAM', 'OKRA', 'LEEK', 'FENNEL', 'SCALLION',
    ];
  ...
  void _getStoredScore() async {
    ...
    if (snapshot.exists) {
      ...
      if (data.containsKey('vegetable')) {
        setState(() {
          score = data['vegetable']['score'];
          foundWords = List<String>.from(data['vegetable']['foundWords']);
          playedWords = Set<String>.from(data['vegetable']['foundWords']); // Update playedWords
        });
      }
    }
  }
