...
class Scramble5 extends StatefulWidget {
  ...
  @override
  _Scramble5State createState() => _Scramble5State();
}

class _Scramble5State extends State<Scramble5> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Scramble Colours'),
  ...
  bool _isValidWord(String word) {
    List<String> validWords = [
      ...
      'WHITE', 'GRAY', 'SILVER', 'GOLD', 'NAVY',
      'TURQUOISE', 'TEAL', 'MAROON', 'MAGENTA',
      'CYAN', 'LAVENDER', 'INDIGO', 'BEIGE', 'CHARCOAL', 'KHAKI', 'CRIMSON', 'CORAL',
      'MAUVE', 'OLIVE', 'PEACH', 'TAN', 'SALMON',
      'VIOLET', 'AQUAMARINE', 'FUCHSIA', 'LIME'
    ];
  ...
  void _getStoredScore() async {
    ...
    if (snapshot.exists) {
      ...
      if (data.containsKey('colour')) {
        setState(() {
          score = data['colour']['score'];
          foundWords = List<String>.from(data['colour']['foundWords']);
          playedWords = Set<String>.from(data['colour']['foundWords']); // Update playedWords
        });
      }
    }
  }
