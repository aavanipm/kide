...
class Scramble5 extends StatefulWidget {
  const Scramble5({Key? key}) : super(key: key);
...
class _Scramble5State extends State<Scramble5> {
  ...
  bool _isValidWord(String word) {
    List<String> validWords = [
      ...
      'WHITE', 'GRAY', 'SILVER', 'GOLD', 'NAVY', 'TURQUOISE', 'TEAL', 'MAROON', 'MAGENTA',
      'CYAN', 'LAVENDER', 'INDIGO', 'BEIGE', 'CHARCOAL', 'KHAKI', 'CRIMSON', 'CORAL',
      'MAUVE', 'OLIVE', 'PEACH', 'TAN', 'SALMON', 'VIOLET', 'AQUAMARINE', 'FUCHSIA', 'LIME'
    ];
