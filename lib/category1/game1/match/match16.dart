...
class Match16 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Match16({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match16State createState() => _Match16State();
}

class _Match16State extends State<Match16> {
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match17()));
  }
