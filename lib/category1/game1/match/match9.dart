...
class Match9 extends StatefulWidget {

  final String username;
  final String email;
  final String age;
  const Match9({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match9State createState() => _Match9State();
}

class _Match9State extends State<Match9> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'beans', imagePath: 'assets/Vegetables/beans.png'),
      Animal(name: 'orange', imagePath: 'assets/Fruits/orange.png'),
      Animal(name: 'papaya', imagePath: 'assets/Fruits/papaya.png'),
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match10(
      username: widget.username, email: widget.email, age: widget.age,
    )));
  }
