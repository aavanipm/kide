...
class Match19 extends StatefulWidget {
  ...
  const Match19({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);

  @override
  _Match19State createState() => _Match19State();
}

class _Match19State extends State<Match19> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'tulip', imagePath: 'assets/Flowers/tulip.png'),
      Animal(name: 'flamingo', imagePath: 'assets/Birds/flamingo.png'),
      Animal(name: 'hibiscus', imagePath: 'assets/Flowers/hibiscus.png'),
