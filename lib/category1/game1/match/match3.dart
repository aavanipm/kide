...
class _Match3State extends State<Match3> {
  ...
  List<List<Animal>> animalSets = [
    [
      ...
      Animal(name: 'bear', imagePath: 'assets/animals/bear.png'),
      Animal(name: 'parrot', imagePath: 'assets/Birds/parrot.png'),
      Animal(name: 'squirrel', imagePath: 'assets/animals/squirrel.png'),
    ],
  ];
