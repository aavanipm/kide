...
class Match6 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Match6({Key? key, required this.username, required this.email, required this.age}) : super(key: key);
...
class _Match6State extends State<Match6> {
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match7(
      username: widget.username, email: widget.email, age: widget.age,
    )));
  }
