...
class Match17 extends StatefulWidget {
  ...
  const Match17({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);

  @override
  _Match17State createState() => _Match17State();
}

class _Match17State extends State<Match17> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'lotus', imagePath: 'assets/Flowers/lotus.png'),
      Animal(name: 'robin', imagePath: 'assets/Birds/robin.png'),
      Animal(name: 'lily', imagePath: 'assets/Flowers/lily.png'),
      Animal(name: 'allamanda', imagePath: 'assets/Flowers/allamanda.png'),
    ],
  ];
