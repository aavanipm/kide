...
class Match18 extends StatefulWidget {
  ...
  const Match18({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);

  @override
  _Match18State createState() => _Match18State();
}

class _Match18State extends State<Match18> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'owl', imagePath: 'assets/Birds/owl.png'),
      Animal(name: 'rose', imagePath: 'assets/Flowers/rose.png'),
      Animal(name: 'sunflower', imagePath: 'assets/Flowers/sunflower.png'),
