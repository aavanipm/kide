...
class Match10 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Match10({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match10State createState() => _Match10State();
}

class _Match10State extends State<Match10> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'eagle', imagePath: 'assets/Birds/eagle.png'),
      Animal(name: 'cow', imagePath: 'assets/animals/cow.png'),
      Animal(name: 'emu', imagePath: 'assets/Birds/emu.png'),
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match11(
        username: widget.username, email: widget.email, age: widget.age
    )));
  }
