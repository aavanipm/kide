...
class Match14 extends StatefulWidget {

  final String username;
  final String email;
  final String age;
  const Match14({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match14State createState() => _Match14State();
}

class _Match14State extends State<Match14> {
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match15(
        username: widget.username, email: widget.email, age: widget.age
    )));
  }
