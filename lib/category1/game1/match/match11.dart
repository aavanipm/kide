...
class Match11 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  const Match11({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match11State createState() => _Match11State();
}

class _Match11State extends State<Match11> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'goat', imagePath: 'assets/animals/goat.png'),
      Animal(name: 'donkey', imagePath: 'assets/animals/donkey.png'),
      Animal(name: 'tiger', imagePath: 'assets/animals/tiger.png'),
      Animal(name: 'deer', imagePath: 'assets/animals/deer.png'),
      Animal(name: 'yak', imagePath: 'assets/animals/yak.png'),
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match12(
        username: widget.username, email: widget.email, age: widget.age
    )));
  }
