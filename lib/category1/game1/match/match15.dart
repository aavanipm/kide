...
class Match15 extends StatefulWidget {

  final String username;
  final String email;
  final String age;
  const Match15({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match15State createState() => _Match15State();
}

class _Match15State extends State<Match15> {
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match16(
        username: widget.username, email: widget.email, age: widget.age
    )));
  }
