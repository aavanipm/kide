...
class Match8 extends StatefulWidget {

  final String username;
  final String email;
  final String age;
  const Match8({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match8State createState() => _Match8State();
}

class _Match8State extends State<Match8> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'pumpkin', imagePath: 'assets/Vegetables/pumpkin.png'),
      Animal(name: 'ant', imagePath: 'assets/animals/ant.png'),
      Animal(name: 'lion', imagePath: 'assets/animals/lion.png'),
      Animal(name: 'tomato', imagePath: 'assets/Vegetables/tomato.png'),
    ],
  ];
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match9(
      username: widget.username, email: widget.email, age: widget.age,
    )));
  }
