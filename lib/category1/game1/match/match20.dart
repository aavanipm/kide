...
class Match20 extends StatefulWidget {
  ...
  const Match20({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);

  @override
  _Match20State createState() => _Match20State();
}

class _Match20State extends State<Match20> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'jasmine', imagePath: 'assets/Flowers/jasmine.png'),
      Animal(name: 'dahlia', imagePath: 'assets/Flowers/dahlia.png'),
      Animal(name: 'cosmos', imagePath: 'assets/Flowers/cosmos.png'),
      Animal(name: 'marigold', imagePath: 'assets/Flowers/marigold.png'),
      Animal(name: 'bougainvillea', imagePath: 'assets/Flowers/bougainvillea.png'),
    ],
  ];
