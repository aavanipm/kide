...
class Match5 extends StatefulWidget {

  final String username;
  final String email;
  final String age;
  const Match5({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match5State createState() => _Match5State();
}

class _Match5State extends State<Match5> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'myna', imagePath: "assets/Birds/myna.png"),
      Animal(name: 'camel', imagePath: 'assets/animals/camel.png'),
      Animal(name: 'elephant', imagePath: 'assets/animals/elephant.png'),
      Animal(name: 'horse', imagePath: 'assets/animals/horse.png'),
    ],
  ];
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match6(
      username: widget.username, email: widget.email, age: widget.age,
    )));
  }
