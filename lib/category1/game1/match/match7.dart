...
class Match7 extends StatefulWidget {

  final String username;
  final String email;
  final String age;
  const Match7({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _Match7State createState() => _Match7State();
}

class _Match7State extends State<Match7> {

  List<List<Animal>> animalSets = [
    [
      Animal(name: 'giraffe', imagePath: 'assets/animals/giraffe.png'),
      Animal(name: 'kangaroo', imagePath: 'assets/animals/kangaroo.png'),
      Animal(name: 'fig', imagePath: 'assets/Fruits/fig.png'),
      Animal(name: 'grape', imagePath: 'assets/Fruits/grape.png'),
    ],
  ];
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match8(
      username: widget.username, email: widget.email, age: widget.age,
    )));
  }
