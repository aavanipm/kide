...
class Match12 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Match12({Key? key, required this.username, required this.email, required this.age}) : super(key: key);
...
class _Match12State extends State<Match12> {
  ...
  void _proceedToNextLevel() {
    Navigator.push(context, MaterialPageRoute(builder: (context)=>Match13(
        username: widget.username, email: widget.email, age: widget.age
    )));
  }
