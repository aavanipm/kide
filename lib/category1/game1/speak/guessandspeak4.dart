...
class GuessandSpeak4 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const GuessandSpeak4({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  _GuessandSpeak4State createState() => _GuessandSpeak4State();
}

class _GuessandSpeak4State extends State<GuessandSpeak4> {
  final List<AnimalItem> animals = [
    AnimalItem(name: 'tomato', imagePath: 'assets/Vegetables/tomato.png'),
  ];
