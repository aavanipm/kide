...
class GuessandSpeak12 extends StatefulWidget {
  ...
  const GuessandSpeak12({Key? key, required this.username, required this.email,
    required this.age, required this.subscribedCategory}) : super(key: key);

  @override
  _GuessandSpeak12State createState() => _GuessandSpeak12State();
}

class _GuessandSpeak12State extends State<GuessandSpeak12> {
  final List<AnimalItem> animals = [
    AnimalItem(name: 'Jasmine', imagePath: 'assets/Flowers/jasmine.png'),
  ];
      ...
      Future.delayed(Duration(seconds: 3), () {
        if (widget.subscribedCategory == 'premium' ||
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => GuessandSpeak13(
                username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
              ),
            ),
          );
