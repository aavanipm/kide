...
class GuessandSpeak11 extends StatefulWidget {
  ...
  const GuessandSpeak11({Key? key, required this.username, required this.email,
    required this.age, required this.subscribedCategory}) : super(key: key);

  @override
  _GuessandSpeak11State createState() => _GuessandSpeak11State();
}

class _GuessandSpeak11State extends State<GuessandSpeak11> {
      ...
      Future.delayed(Duration(seconds: 3), () {
        if (widget.subscribedCategory == 'premium' ||
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => GuessandSpeak12(
                username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
              ),
            ),
          );
