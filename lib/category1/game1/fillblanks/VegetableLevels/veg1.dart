...
class Veg1 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Veg1({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  State<Veg1> createState() => _Veg1State();
}
