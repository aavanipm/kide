...
class Veg10 extends StatefulWidget {
  ...
  @override
  State<Veg10> createState() => _Veg10State();
}

class _Veg10State extends State<Veg10> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "B R O C C O _ I"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Veg11(
                            username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
                          ),
                          ),
                        );
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "B R O C C O $_selectedOption I"; // Update the word with selected option
