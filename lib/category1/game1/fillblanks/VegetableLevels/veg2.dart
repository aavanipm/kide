...
class Veg2 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Veg2({Key? key, required this.username, required this.email, required this.age}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              "assets/Vegetables/carrot.png", // Change the image path for level 2
              height: 200,
              width: 200,
            ),
            SizedBox(height: 10),
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Veg3(
