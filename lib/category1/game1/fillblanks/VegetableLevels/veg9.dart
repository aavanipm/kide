...
class Veg9 extends StatefulWidget {
  ...
  @override
  State<Veg9> createState() => _Veg9State();
}

class _Veg9State extends State<Veg9> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "C A _ L I F L O W E R"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Veg10(
                            username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
                          ),
                          ),
                        );
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "C A $_selectedOption L I F L O W E R"; // Update the word with selected option
