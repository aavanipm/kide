...
class Fruit11 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Fruit11({Key? key, required this.username, required this.email, required this.age}) : super(key: key);
          ...
          children: [
            ...
            _answeredCorrectly
              ...
              children: [
                ...
                : ElevatedButton(
              onPressed: () {
                if (!_answeredCorrectly && _answer == 'J') {
                  setState(() {
                    _answeredCorrectly = true;
                    if (score == 10){
                      score = 11; // Score becomes 1 on correct answer
