...
class Veg11 extends StatefulWidget {
  ...
  @override
  State<Veg11> createState() => _Veg11State();
}

class _Veg11State extends State<Veg11> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "B I _ T E R G O U R D"; // Initial word with underscore
          ...
          Expanded(
            child: Center(
              child: Column(
                ...
                children: [
                  Image.asset(
                    "assets/Vegetables/bittergourd.png",
                    height: 200,
                    width: 200,
                  ),
                  SizedBox(height: 20),
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "B I T $_selectedOption E R G O U R D"; // Update the word with selected option
