...
class Veg8 extends StatefulWidget {
  ...
  @override
  State<Veg8> createState() => _Veg8State();
}

class _Veg8State extends State<Veg8> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "L A _ Y F I N G E R"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Veg9(
                            username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
                          ),
                          ),
                        );
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "L A $_selectedOption Y F I N G E R"; // Update the word with selected option
