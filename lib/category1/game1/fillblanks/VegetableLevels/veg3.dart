...
class Veg3 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  const Veg3({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  State<Veg3> createState() => _Veg3State();
}

class _Veg3State extends State<Veg3> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              "assets/Vegetables/tomato.png", // Change the image path for level 2
              height: 200,
              width: 200,
            ),
            SizedBox(height: 10),
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Veg4(
                ...
                : ElevatedButton(
              onPressed: () {
                if (!_answeredCorrectly && _answer == 'M') {
                  setState(() {
