...
class _Veg3State extends State<Veg3> {
  ...
  int score = 0;
  String _word = "T O _ A T O"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "T O $_selectedOption A T O"; // Update the word with selected option
      if (_selectedOption == 'M') {
