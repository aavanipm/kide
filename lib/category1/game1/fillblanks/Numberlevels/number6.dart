...
import 'package:game/category1/game1/fillblanks/Numberlevels/number7.dart';
...
class _Number6State extends State<Number6> {
  ...
  int score = 0;
  String _word = "S I _"; // Initial word with underscore
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>NumberLevel(
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' ||widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number7(
                            username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,
                          ),
                          ),
                        );
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "S I $_selectedOption"; // Update the word with selected option
