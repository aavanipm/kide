...
import 'package:game/category1/game1/fillblanks/Numberlevels/number8.dart';
...
class _Number7State extends State<Number7> {
  ...
  int score = 0;
  String _word = "S E _ E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number8(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "S E $_selectedOption E N"; // Update the word with selected option
