...
import 'package:game/category1/game1/fillblanks/Numberlevels/number12.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number11 extends StatefulWidget {
  ...
  @override
  State<Number11> createState() => _Number11State();
}

class _Number11State extends State<Number11> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "E _ E V E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'standard' || widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number12(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "E $_selectedOption E V E N"; // Update the word with selected option
      if (_selectedOption == 'L') {
        _answeredCorrectly = true;
        if (score == 10) {
          score = 11; // Score becomes 7 on correct answer
