...
import 'package:game/category1/game1/fillblanks/Numberlevels/number20.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number19 extends StatefulWidget {
  ...
  @override
  State<Number19> createState() => _Number19State();
}

class _Number19State extends State<Number19> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "N I N E T _ E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number20(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "N I N E T $_selectedOption E N"; // Update the word with selected option
