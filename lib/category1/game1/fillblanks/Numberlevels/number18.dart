...
import 'package:game/category1/game1/fillblanks/Numberlevels/number19.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number18 extends StatefulWidget {
  ...
  @override
  State<Number18> createState() => _Number18State();
}

class _Number18State extends State<Number18> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "E I _ H T E E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number19(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "E I $_selectedOption H T E E N"; // Update the word with selected option
      if (_selectedOption == 'G') {
        _answeredCorrectly = true;
        if (score == 17) {
          score = 18; // Score becomes 7 on correct answer
