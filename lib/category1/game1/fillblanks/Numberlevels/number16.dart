...
import 'package:game/category1/game1/fillblanks/Numberlevels/number17.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number16 extends StatefulWidget {
  ...
  @override
  State<Number16> createState() => _Number16State();
}

class _Number16State extends State<Number16> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "S _ X T E E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number17(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "S $_selectedOption X T E E N"; // Update the word with selected option
      if (_selectedOption == 'I') {
        _answeredCorrectly = true;
        if (score == 15) {
          score = 16; // Score becomes 7 on correct answer
