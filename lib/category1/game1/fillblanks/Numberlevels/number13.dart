...
import 'package:game/category1/game1/fillblanks/Numberlevels/number14.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number13 extends StatefulWidget {
  ...
  @override
  State<Number13> createState() => _Number13State();
}

class _Number13State extends State<Number13> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "T _ I R T E E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'standard' || widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number14(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "T $_selectedOption I R T E E N"; // Update the word with selected option
