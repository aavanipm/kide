...
import 'package:game/category1/game1/fillblanks/Numberlevels/number15.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number14 extends StatefulWidget {
  ...
  @override
  State<Number14> createState() => _Number14State();
}

class _Number14State extends State<Number14> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "F _ U R T E E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'standard' || widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number15(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "F $_selectedOption U R T E E N"; // Update the word with selected option
      if (_selectedOption == 'O') {
        _answeredCorrectly = true;
        if (score == 13) {
          score = 14; // Score becomes 7 on correct answer
