...
import 'package:game/category1/game1/fillblanks/Numberlevels/number16.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number15 extends StatefulWidget {
  ...
  @override
  State<Number15> createState() => _Number15State();
}

class _Number15State extends State<Number15> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "F I _ T E E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number16(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "F I $_selectedOption T E E N"; // Update the word with selected option
      if (_selectedOption == 'F') {
        _answeredCorrectly = true;
        if (score == 14) {
          score = 15; // Score becomes 7 on correct answer
