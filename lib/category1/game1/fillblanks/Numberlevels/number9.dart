...
import 'package:game/category1/game1/fillblanks/Numberlevels/number10.dart';
...
class _Number9State extends State<Number9> {
  ...
  int score = 0;
  String _word = "N _ N E"; // Initial word with underscore
              ...
              onPressed: () {
                if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context)=> Number10(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "N $_selectedOption N E"; // Update the word with selected option
