...
import 'package:game/category1/game1/fillblanks/AnimalLevels/fill21.dart';
import 'package:game/category1/game1/fillblanks/AnimalLevels/levelsfill.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/number21.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlast.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number20 extends StatefulWidget {
  ...
  @override
  State<Number20> createState() => _Number20State();
}

class _Number20State extends State<Number20> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "_ W E N T Y"; // Initial word with underscore
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          padding: EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                          textStyle: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: _selectedOption == 'F' ? Colors.black : Colors.grey),
                          backgroundColor: _answeredCorrectly ? Colors.grey[300] : Colors.yellow[200], // Adjust color based on _answeredCorrectly
                        ),
                        child: Text('F'),
                      ),
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          padding: EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                          textStyle: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: _selectedOption == 'Q' ? Colors.black : Colors.grey),
                          backgroundColor: _answeredCorrectly ? Colors.grey[300] : Colors.yellow[200], // Adjust color based on _answeredCorrectly
                        ),
                        child: Text('Q'),
                      ),
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> NumberLast(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "$_selectedOption W E N T Y"; // Update the word with selected option
      if (_selectedOption == 'T') {
        _answeredCorrectly = true;
        if (score == 19) {
          score = 20; // Score becomes 7 on correct answer
