...
import 'package:game/category1/game1/fillblanks/Numberlevels/number13.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number12 extends StatefulWidget {
  ...
  @override
  State<Number12> createState() => _Number12State();
}

class _Number12State extends State<Number12> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "T _ E L V E"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'standard' || widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number13(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "T $_selectedOption E L V E"; // Update the word with selected option
      if (_selectedOption == 'W') {
        _answeredCorrectly = true;
        if (score == 11) {
          score = 12; // Score becomes 7 on correct answer
