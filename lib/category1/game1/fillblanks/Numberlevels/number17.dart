...
import 'package:game/category1/game1/fillblanks/Numberlevels/number18.dart';
import 'package:game/category1/game1/fillblanks/Numberlevels/numberlevel.dart';

class Number17 extends StatefulWidget {
  ...
  @override
  State<Number17> createState() => _Number17State();
}

class _Number17State extends State<Number17> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "_ E V E N T E E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Number18(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "$_selectedOption E V E N T E E N"; // Update the word with selected option
      if (_selectedOption == 'S') {
        _answeredCorrectly = true;
        if (score == 16) {
          score = 17; // Score becomes 7 on correct answer
