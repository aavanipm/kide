...
class Bird7 extends StatefulWidget {
  ...
  @override
  State<Bird7> createState() => _Bird7State();
}

class _Bird7State extends State<Bird7> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "W _ E N"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Bird8(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "W $_selectedOption E N"; // Update the word with selected option
