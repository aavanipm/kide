...
class Bird15 extends StatefulWidget {
  ...
  @override
  State<Bird15> createState() => _Bird15State();
}

class _Bird15State extends State<Bird15> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "R O O _ T E R"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Bird16(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "R O O $_selectedOption T E R"; // Update the word with selected option
      if (_selectedOption == 'S') {
        _answeredCorrectly = true;
        if (score == 14) {
          score = 15; // Score becomes 1 on correct answer
