...
import 'package:game/category1/game1/fillblanks/BirdLevels/birdlast.dart';

class Bird20 extends StatefulWidget {
  ...
  @override
  State<Bird20> createState() => _Bird20State();
}

class _Bird20State extends State<Bird20> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word ="C O U _ A L"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> BirdLast(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "C O U $_selectedOption A L"; // Update the word with selected option
      if (_selectedOption == 'C') {
        _answeredCorrectly = true;
        if (score == 19) {
          score = 20; // Score becomes 1 on correct answer
