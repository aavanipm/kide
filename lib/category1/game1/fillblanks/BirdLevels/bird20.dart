...
class Bird20 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Bird20({Key? key, required this.username, required this.email, required this.age}) : super(key: key);
  @override
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=> Bird21(),
                      ),
                    );
                  },
                ...
                : ElevatedButton(
              onPressed: () {
                if (!_answeredCorrectly && _answer == 'G') {
                  setState(() {
