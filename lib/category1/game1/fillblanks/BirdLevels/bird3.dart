...
class Bird3 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  const Bird3({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  State<Bird3> createState() => _Bird3State();
}

class _Bird3State extends State<Bird3> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              "assets/Birds/hen.png", // Change the image path for level 2
              height: 200,
              width: 200,
            ),
            SizedBox(height: 10),
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Bird4(
