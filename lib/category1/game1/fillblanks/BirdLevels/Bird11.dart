...
class Bird11 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  const Bird11({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  State<Bird11> createState() => _Bird11State();
}

class _Bird11State extends State<Bird11> {
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=> Bird12(
                ...
                : ElevatedButton(
              onPressed: () {
                if (!_answeredCorrectly && _answer == 'I') {
                  setState(() {
