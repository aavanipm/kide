...
class Bird5 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  const Bird5({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  State<Bird5> createState() => _Bird5State();
}

class _Bird5State extends State<Bird5> {
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=> Bird6(
