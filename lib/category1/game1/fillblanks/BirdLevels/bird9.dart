...
class Bird9 extends StatefulWidget {
  ...
  @override
  State<Bird9> createState() => _Bird9State();
}

class _Bird9State extends State<Bird9> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "_ A R R O T"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Bird10(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "$_selectedOption A R R O T"; // Update the word with selected option
