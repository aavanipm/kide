...
class Bird12 extends StatefulWidget {
  ...
  @override
  State<Bird12> createState() => _Bird12State();
}

class _Bird12State extends State<Bird12> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "T U R _ E Y"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Bird13(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "T U R $_selectedOption E Y"; // Update the word with selected option
      if (_selectedOption == 'K') {
        _answeredCorrectly = true;
        if (score == 11) {
          score = 12; // Score becomes 1 on correct answer
