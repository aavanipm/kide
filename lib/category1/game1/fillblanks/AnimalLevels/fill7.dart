...
class Fill7 extends StatefulWidget {
  ...
  @override
  State<Fill7> createState() => _Fill7State();
}

class _Fill7State extends State<Fill7> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "B E _ R"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "B E $_selectedOption R"; // Update the word with selected option
      if (_selectedOption == 'A') {
        _answeredCorrectly = true;
        if (score == 6) {
          score = 7; // Score becomes 7 on correct answer
