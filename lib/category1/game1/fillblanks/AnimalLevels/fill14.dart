...
class Fill14 extends StatefulWidget {
  ...
  @override
  State<Fill14> createState() => _Fill14State();
}

class _Fill14State extends State<Fill14> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "S H E E _"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "S H E E $_selectedOption"; // Update the word with selected option
