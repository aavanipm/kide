...
class Fill12 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  const Fill12({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  State<Fill12> createState() => _Fill12State();
}

class _Fill12State extends State<Fill12> {
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=> Fill13(
