...
class Fill11 extends StatefulWidget {
  ...
  @override
  State<Fill11> createState() => _Fill11State();
}

class _Fill11State extends State<Fill11> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "H O _ S E"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "H O $_selectedOption S E"; // Update the word with selected option
