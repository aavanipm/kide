...
class Fill17 extends StatefulWidget {
  ...
  @override
  State<Fill17> createState() => _Fill17State();
}

class _Fill17State extends State<Fill17> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "C H E E _ A H"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "C H E E $_selectedOption A H"; // Update the word with selected option
