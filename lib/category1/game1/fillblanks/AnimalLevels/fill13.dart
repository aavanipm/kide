...
class Fill13 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Fill13({Key? key, required this.username, required this.email, required this.age}) : super(key: key);
  @override
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=> Fill14(
                ...
                : ElevatedButton(
              onPressed: () {
                if (!_answeredCorrectly && _answer == 'C') {
                  setState(() {
