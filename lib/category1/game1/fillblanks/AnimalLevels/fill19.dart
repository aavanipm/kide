...
class Fill19 extends StatefulWidget {
  ...
  @override
  State<Fill19> createState() => _Fill19State();
}

class _Fill19State extends State<Fill19> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "S _ U I R R E L"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "S $_selectedOption U I R R E L"; // Update the word with selected option
      if (_selectedOption == 'Q') {
        _answeredCorrectly = true;
        if (score == 18) {
          score = 19; // Score becomes 7 on correct answer
