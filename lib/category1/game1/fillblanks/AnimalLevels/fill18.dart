...
class Fill18 extends StatefulWidget {
  ...
  @override
  State<Fill18> createState() => _Fill18State();
}

class _Fill18State extends State<Fill18> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "G I R A F _ E"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "G I R A F $_selectedOption E"; // Update the word with selected option
