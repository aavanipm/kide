...
class _Fruit3State extends State<Fruit3> {
  ...
  int score = 0;
  String _word = "F I _"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "F I $_selectedOption"; // Update the word with selected option
      if (_selectedOption == 'G') {
        _answeredCorrectly = true;
        if (score == 2) {
          score = 3; // Score becomes 2 on correct answer
