...
class Fruit3 extends StatefulWidget {
  ...
  final String email;
  final String age;
  const Fruit3({Key? key, required this.username, required this.email, required this.age}) : super(key: key);

  @override
  State<Fruit3> createState() => _Fruit3State();
}

class _Fruit3State extends State<Fruit3> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              "assets/Fruits/fig.png", // Change the image path for level 2
              height: 200,
              width: 200,
            ),
            SizedBox(height: 10),
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Fruit4(
