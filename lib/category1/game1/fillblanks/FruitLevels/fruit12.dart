...
class Fruit12 extends StatefulWidget {
  ...
  @override
  State<Fruit12> createState() => _Fruit12State();
}

class _Fruit12State extends State<Fruit12> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "_ T R A W B E R R Y"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Fruit13(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "$_selectedOption T R A W B E R R Y"; // Update the word with selected option
      if (_selectedOption == 'S') {
        _answeredCorrectly = true;
        if (score == 11) {
          score = 12; // Score becomes 2 on correct answer
