...
class Fruit9 extends StatefulWidget {
  ...
  @override
  State<Fruit9> createState() => _Fruit9State();
}

class _Fruit9State extends State<Fruit9> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "A P R I C _ T"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Fruit10(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "A P R I C $_selectedOption T"; // Update the word with selected option
      if (_selectedOption == 'O') {
        _answeredCorrectly = true;
        if (score == 8) {
          score = 9; // Score becomes 2 on correct answer
