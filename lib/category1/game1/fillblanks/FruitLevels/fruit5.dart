...
class Fruit5 extends StatefulWidget {
  ...
  @override
  State<Fruit5> createState() => _Fruit5State();
}

class _Fruit5State extends State<Fruit5> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "M A N _ O"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Fruit6(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "M A N $_selectedOption O"; // Update the word with selected option
      if (_selectedOption == 'G') {
        _answeredCorrectly = true;
        if (score == 4) {
          score = 5; // Score becomes 2 on correct answer
