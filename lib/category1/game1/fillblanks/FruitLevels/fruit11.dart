...
class Fruit11 extends StatefulWidget {
  ...
  @override
  State<Fruit11> createState() => _Fruit11State();
}

class _Fruit11State extends State<Fruit11> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "J A C _ F R U I T"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Fruit12(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "J A C $_selectedOption F R U I T"; // Update the word with selected option
      if (_selectedOption == 'K') {
        _answeredCorrectly = true;
        if (score == 10) {
          score = 11; // Score becomes 2 on correct answer
