...
class _Fruit8State extends State<Fruit8> {
  ...
  int score = 0;
  String _word = "_ A N A N A"; // Initial word with underscore
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "$_selectedOption A N A N A"; // Update the word with selected option
      if (_selectedOption == 'B') {
        _answeredCorrectly = true;
        if (score == 7) {
          score = 8; // Score becomes 2 on correct answer
