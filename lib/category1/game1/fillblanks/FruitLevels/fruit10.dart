...
class Fruit10 extends StatefulWidget {
  ...
  @override
  State<Fruit10> createState() => _Fruit10State();
}

class _Fruit10State extends State<Fruit10> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "P A P A _ A"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Fruit11(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "P A P A $_selectedOption A"; // Update the word with selected option
      if (_selectedOption == 'Y') {
        _answeredCorrectly = true;
        if (score == 9) {
          score = 10; // Score becomes 2 on correct answer
