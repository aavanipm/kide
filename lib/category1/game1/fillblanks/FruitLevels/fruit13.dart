...
class Fruit13 extends StatefulWidget {
  ...
  @override
  State<Fruit13> createState() => _Fruit13State();
}

class _Fruit13State extends State<Fruit13> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "P O M E G R _ N A T E"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Fruit14(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "P O M E G R $_selectedOption N A T E"; // Update the word with selected option
      if (_selectedOption == 'A') {
        _answeredCorrectly = true;
        if (score == 12) {
          score = 13; // Score becomes 2 on correct answer
