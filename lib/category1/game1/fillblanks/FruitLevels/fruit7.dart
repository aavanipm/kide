...
class Fruit7 extends StatefulWidget {
  ...
  @override
  State<Fruit7> createState() => _Fruit7State();
}

class _Fruit7State extends State<Fruit7> {
  String _selectedOption = '';
  bool _answeredCorrectly = false;
  int score = 0;
  String _word = "O _ A N G E"; // Initial word with underscore
                    ...
                    onPressed: () {
                      if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context)=> Fruit8(
  ...
  void _selectOption(String option) {
    setState(() {
      ...
      _word = "O $_selectedOption A N G E"; // Update the word with selected option
      if (_selectedOption == 'R') {
        _answeredCorrectly = true;
        if (score == 6) {
          score = 7; // Score becomes 2 on correct answer
