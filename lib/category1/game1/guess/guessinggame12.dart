...
class GuessingGame12 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  final String subscribedCategory;

  GuessingGame12({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);
  @override
  _GuessingGame12State createState() => _GuessingGame12State();
}

class _GuessingGame12State extends State<GuessingGame12> {
  int score = 0;
  List<Animal> animals = [
    Animal(name: 'bear', imagePath: 'assets/animals/bear.png', points: 1),
    Animal(name: 'kangaroo', imagePath: 'assets/animals/kangaroo.png', points: 1),
    Animal(name: 'fox', imagePath: 'assets/animals/fox.png', points: 1),
    Animal(name: 'turkey', imagePath: 'assets/Birds/turkey.png', points: 1),
  ];
                ...
                ElevatedButton(
                  onPressed: () {
                    if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => GuessingGame13(
  ...
  void _submitGuesses() {
    ...
    for (var animal in animals) {
      if (animal.matched == false && animal.name.toLowerCase() == animal.typedName.trim().toLowerCase()) {
        ...
        if(score==24 || score==25 || score==26 || score==27){
