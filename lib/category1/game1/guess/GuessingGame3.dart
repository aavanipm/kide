...
class GuessingGame3 extends StatefulWidget {
  ...
  GuessingGame3({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);
  @override
  State<GuessingGame3> createState() => _GuessingGame3State();
}

class _GuessingGame3State extends State<GuessingGame3> {
  final Animal animal = Animal(name: "Tiger", imagePath: "assets/animals/tiger.png");
  ...
  void _goToNextLevel() {
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>GuessingGame4(
        username: widget.username, email: widget.email, age: widget.age, subscribedCategory: widget.subscribedCategory,)));
  }
