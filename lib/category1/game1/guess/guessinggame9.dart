...
class GuessingGame9 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  final String subscribedCategory;

  GuessingGame9({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);
  @override
  _GuessingGame9State createState() => _GuessingGame9State();
}

class _GuessingGame9State extends State<GuessingGame9> {
  int score = 0;
  List<Animal> animals = [
    Animal(name: 'Elephant', imagePath: 'assets/animals/elephant.png', points: 1),
    Animal(name: 'hen', imagePath: 'assets/Birds/hen.png', points: 1),
    Animal(name: 'yak', imagePath: 'assets/animals/yak.png', points: 1),
    Animal(name: 'rooster', imagePath: 'assets/Birds/rooster.png', points: 1),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (widget.subscribedCategory == 'basic' || widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => GuessingGame10(
  ...
  void _submitGuesses() {
    ...
    for (var animal in animals) {
      if (animal.matched == false && animal.name.toLowerCase() == animal.typedName.trim().toLowerCase()) {
        ...
        if(score==12 || score==13 || score==14 || score==15){
