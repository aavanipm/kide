...
class GuessingGame10 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  final String subscribedCategory;

  GuessingGame10({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);
  @override
  _GuessingGame10State createState() => _GuessingGame10State();
}

class _GuessingGame10State extends State<GuessingGame10> {
  int score = 0;
  List<Animal> animals = [
    Animal(name: 'Sheep', imagePath: 'assets/animals/sheep.png', points: 1),
    Animal(name: 'Donkey', imagePath: 'assets/animals/donkey.png', points: 1),
    Animal(name: 'owl', imagePath: 'assets/Birds/owl.png', points: 1),
    Animal(name: 'pigeon', imagePath: 'assets/Birds/pigeon.png', points: 1),
                  ...
                  onPressed: () {
                    if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => GuessingGame11(
  ...
  void _submitGuesses() {
    ...
    for (var animal in animals) {
      if (animal.matched == false && animal.name.toLowerCase() == animal.typedName.trim().toLowerCase()) {
        ...
        if(score==16 || score==17 || score==18 || score==19){
