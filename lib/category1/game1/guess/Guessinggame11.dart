...
class GuessingGame11 extends StatefulWidget {
  final String username;
  final String email;
  final String age;
  final String subscribedCategory;

  GuessingGame11({Key? key, required this.username, required this.email, required this.age, required this.subscribedCategory}) : super(key: key);
  @override
  _GuessingGame11State createState() => _GuessingGame11State();
}

class _GuessingGame11State extends State<GuessingGame11> {
  int score = 0;
  List<Animal> animals = [
    Animal(name: 'monkey', imagePath: 'assets/animals/monkey.png', points: 1),
    Animal(name: 'squirrel', imagePath: 'assets/animals/squirrel.png', points: 1),
    Animal(name: 'emu', imagePath: 'assets/Birds/emu.png', points: 1),
    Animal(name: 'woodpecker', imagePath: 'assets/Birds/woodpecker.png', points: 1),
  ];
                ...
                ElevatedButton(
                  onPressed: () {
                    if (widget.subscribedCategory == 'premium' || widget.subscribedCategory == 'standard') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => GuessingGame12(
  ...
  void _submitGuesses() {
    ...
    for (var animal in animals) {
      if (animal.matched == false && animal.name.toLowerCase() == animal.typedName.trim().toLowerCase()) {
        ...
        if(score==20 || score==21 || score==22 || score==23){
