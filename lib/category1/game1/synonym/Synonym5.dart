...
//   const Synonym5({Key? key}) : super(key: key);
//
//   @override
...
//     'fast': ['Quick', 'Rapid', 'Swift', 'Speedy', 'Hasty', 'Fleet', 'Expeditious', 'Brisk'],
//   };
//
//   final Map<String, List<String>> wordNotSimilar = {
//     'fast': ['Sluggish', 'Leisurely', 'Gradual', 'Languid', 'Plodding', 'Tardy', 'Relaxed', 'Moderate'],
//   };
//
