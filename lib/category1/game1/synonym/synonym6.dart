...
class Synonym6 extends StatefulWidget {
  const Synonym6({Key? key}) : super(key: key);
...
class _Synonym6State extends State<Synonym6> {
  final Map<String, List<String>> wordSynonyms = {
    'slow': ['Sluggish', 'Leisurely', 'Gradual', 'Languid', 'Plodding', 'Tardy', 'Relaxed', 'Moderate'],
  };

  final Map<String, List<String>> wordNotSimilar = {
    'slow': ['Quick', 'Rapid', 'Swift', 'Speedy', 'Hasty', 'Fleet', 'Expeditious', 'Brisk'],
  };
