...
//   const Synonym7({Key? key}) : super(key: key);
//
//   @override
...
//     'good': ['Excellent', 'Great', 'Wonderful', 'Fantastic', 'Superb', 'Fine', 'Terrific', 'Outstanding'
//     ],
//   };
//
//   final Map<String, List<String>> wordNotSimilar = {
//     'good': ['Poor', 'Awful', 'Terrible', 'Horrible', 'Unpleasant', 'Negative', 'Inferior', 'Substandard'
//     ],
//   };
//
