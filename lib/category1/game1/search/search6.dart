...
class Search6 extends StatefulWidget {
  ...
  @override
  _Search6State createState() => _Search6State();
}

class _Search6State extends State<Search6> {
  final List<String> wordsToFind = ['MOON', 'SUN', 'STAR', 'EARTH'];
