...
class Search7 extends StatefulWidget {
  ...
  @override
  _Search7State createState() => _Search7State();
}

class _Search7State extends State<Search7> {
  final List<String> wordsToFind = ['BUTTERFLY', 'RAIN', 'SNOW', 'TRAIN'];
