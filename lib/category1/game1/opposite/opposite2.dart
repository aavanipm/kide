...
class Opposite2 extends StatefulWidget {
  ...
  @override
  _Opposite2State createState() => _Opposite2State();
}

class _Opposite2State extends State<Opposite2> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 2! Moving to the next level...',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 70,),
              Image.asset("assets/opposite/hotcold.png", height: 300, width: 300,),
            ],
          ),
        ),
      ),
