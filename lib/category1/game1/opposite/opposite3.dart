...
class Opposite3 extends StatefulWidget {
  ...
  @override
  _Opposite3State createState() => _Opposite3State();
}

class _Opposite3State extends State<Opposite3> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 3! Moving to the next level...',
