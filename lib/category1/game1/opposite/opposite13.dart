...
class Opposite13 extends StatefulWidget {
  ...
  @override
  _Opposite13State createState() => _Opposite13State();
}

class _Opposite13State extends State<Opposite13> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 13! Moving to the next level...',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _buildDraggableWord('DAY'),
                  SizedBox(width: 10),
                  _buildDraggableWord('CONFUSE'),
                  SizedBox(width: 10),
                  _buildDraggableWord('WIN'),
                  SizedBox(width: 10),
                  _buildDraggableWord('OUTSIDE'),
                ],
              ),
              SizedBox(height: 30),
              Card(
