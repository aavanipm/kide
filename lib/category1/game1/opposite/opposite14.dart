...
class Opposite14 extends StatefulWidget {
  ...
  @override
  _Opposite14State createState() => _Opposite14State();
}

class _Opposite14State extends State<Opposite14> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 14! Moving to the next level...',
