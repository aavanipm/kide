...
class Opposite5 extends StatefulWidget {
  ...
  @override
  _Opposite5State createState() => _Opposite5State();
}

class _Opposite5State extends State<Opposite5> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 5! Moving to the next level...',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 70,),
              Image.asset("assets/opposite/bigsmall.png", height: 300, width: 300,),
            ],
          ),
        ),
      ),
