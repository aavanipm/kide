...
class Opposite11 extends StatefulWidget {
  ...
  @override
  _Opposite11State createState() => _Opposite11State();
}

class _Opposite11State extends State<Opposite11> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 11! Moving to the next level...',
