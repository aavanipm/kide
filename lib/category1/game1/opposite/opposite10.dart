...
class Opposite10 extends StatefulWidget {
  ...
  @override
  _Opposite10State createState() => _Opposite10State();
}

class _Opposite10State extends State<Opposite10> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 10! Moving to the next level...',
