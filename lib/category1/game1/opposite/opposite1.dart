...
class Opposite1 extends StatefulWidget {
  ...
  @override
  _Opposite1State createState() => _Opposite1State();
}

class _Opposite1State extends State<Opposite1> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 1! Moving to the next level...',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 70,),
              Image.asset("assets/opposite/sadhappy.png", height: 300, width: 300,),
            ],
          ),
        ),
      ),
