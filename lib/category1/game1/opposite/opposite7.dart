...
class Opposite7 extends StatefulWidget {
  ...
  @override
  _Opposite7State createState() => _Opposite7State();
}

class _Opposite7State extends State<Opposite7> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 7! Moving to the next level...',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 70,),
              Image.asset("assets/opposite/lowhigh.png", height: 300, width: 300,),
            ],
          ),
        ),
      ),
