...
class Opposite12 extends StatefulWidget {
  ...
  @override
  _Opposite12State createState() => _Opposite12State();
}

class _Opposite12State extends State<Opposite12> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 12! Moving to the next level...',
