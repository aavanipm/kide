...
class Opposite6 extends StatefulWidget {
  ...
  @override
  _Opposite6State createState() => _Opposite6State();
}

class _Opposite6State extends State<Opposite6> {
  ...
  void goToNextLevel() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Completed Level 6! Moving to the next level...',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 70,),
              Image.asset("assets/opposite/fastslow.png", height: 300, width: 300,),
            ],
          ),
        ),
      ),
